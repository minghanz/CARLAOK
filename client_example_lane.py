...
# FIFO_IMAGES = 'images.fifo'
# # FIFO_Lanes = "lanes.fifo"
...
def run_carla_client(args):
    ...
    with make_carla_client(args.host, args.port) as client:
        ...
        if args.settings_filepath is None:
            ...
            camera0.set_position(0.30, 0, 2.30)
        ...
        for frame in range(0, frames_per_episode):
            ...
            # ptclouds = sensor_data['Lidar32'].horizontal_angle
            # ptclouds = sensor_data['Lidar32'].data
            # print(ptclouds)
